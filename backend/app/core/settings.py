...
AVANZA_FUND_MAX_CALLS = _int_env("APP_AVANZA_FUND_MAX_CALLS", 30)
AVANZA_FUND_PERIOD_SECONDS = _int_env("APP_AVANZA_FUND_PERIOD_SECONDS", 60)
AVANZA_FUND_CACHE_SECONDS = _int_env("APP_AVANZA_FUND_CACHE_SECONDS", 20 * 60 * 60)
